  ...
  return (
    <>
      ...
      <Box
        ...
        style={{
          height: '100vh',
          backgroundImage: 'url("https://www.bestoflanka.com/images/slider/stay-in-the-beach-sri-lanka/hotel-goldi-sands/02.jpg")', // Add the path to your background image here
